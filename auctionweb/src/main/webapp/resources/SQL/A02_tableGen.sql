...
CREATE SEQUENCE  "AUCTION"."AUCTION_NOTICE_SEQ"  MINVALUE 1 MAXVALUE 999999999 INCREMENT BY 1 START WITH 1 NOCACHE  NOORDER  NOCYCLE ;
...
ALTER TABLE AUCTION_NOTICE
   ADD CONSTRAINT sys_c007007 PRIMARY KEY (AUCTION_NOTICE) VALIDATE;
...
ALTER TABLE user_message
   ADD CONSTRAINT fk_user_message_2 FOREIGN KEY (sender_id)
       REFERENCES "AUCTION".auction_user (user_id) ON DELETE SET NULL
       VALIDATE;
ALTER TABLE user_message
   ADD CONSTRAINT fk_user_message_1 FOREIGN KEY (receiver_id)
       REFERENCES "AUCTION".auction_user (user_id) ON DELETE SET NULL
       VALIDATE;
ALTER TABLE user_message
...
ALTER TABLE user_payment
   ADD CONSTRAINT fk_user_payment_1 FOREIGN KEY (user_id)
       REFERENCES "AUCTION".auction_user (user_id) on DELETE CASCADE 
       VALIDATE;
ALTER TABLE user_payment
...
ALTER TABLE auction_item
   ADD CONSTRAINT fk_auction_item_1 FOREIGN KEY (auctioneer_id)
       REFERENCES "AUCTION".auctioneer_info (auctioneer_id) ON DELETE SET NULL
       VALIDATE;
ALTER TABLE auction_item
...
ALTER TABLE auction_notice
   MODIFY notice_content CONSTRAINT sys_c0013427 NOT NULL VALIDATE;
ALTER TABLE auction_notice
   MODIFY notice_title CONSTRAINT sys_c0013426 NOT NULL VALIDATE;
ALTER TABLE auction_notice
   ADD CONSTRAINT sys_c0013428 PRIMARY KEY (notice_id) VALIDATE;
...
CREATE OR REPLACE TRIGGER TR_AUCTION_NOTICE
   BEFORE INSERT
   ON "AUCTION"."AUCTION_NOTICE"
   FOR EACH ROW
BEGIN
   IF INSERTING
   THEN
      ...
      THEN
         SELECT AUCTION_NOTICE_SEQ.NEXTVAL INTO :NEW."NOTICE_ID" FROM DUAL;
      END IF;
   END IF;
END;