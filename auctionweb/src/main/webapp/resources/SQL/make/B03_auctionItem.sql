...
INSERT INTO AUCTION_ITEM (AUCTIONEER_ID, ITEM_NAME, ITEM_CONTENT,START_DATE, END_DATE,
						 CURRENT_BIDDER_ID, CURRENT_BIDDER, CURRENT_BID_AMOUNT, CATEGORY_ID, PICTURE_LOCATION)
        VALUES ( 2,
                 '(TEST)Samsung Galaxy Note 5 SM-N920A 32GB GSM Unlocked Cellphone, Black',
...
INSERT INTO AUCTION_ITEM (AUCTIONEER_ID, ITEM_NAME, ITEM_CONTENT,START_DATE, END_DATE,
						 CURRENT_BIDDER_ID, CURRENT_BIDDER, CURRENT_BID_AMOUNT, CATEGORY_ID, PICTURE_LOCATION)
        VALUES ( 2,
                 '(TEST)BlackBerry KEYone GSM Unlocked Android Smartphone (AT&T, T-Mobile) - 4G LTE – 32GB',
...
INSERT INTO AUCTION_ITEM (AUCTIONEER_ID, ITEM_NAME, ITEM_CONTENT,START_DATE, END_DATE,
						 CURRENT_BIDDER_ID, CURRENT_BIDDER, CURRENT_BID_AMOUNT, CATEGORY_ID, PICTURE_LOCATION)
        VALUES ( 2,
                 '(TEST)LG G5 Unlocked Phone, 32 GB Titan (US Warranty)',
...
INSERT INTO AUCTION_ITEM (AUCTIONEER_ID, ITEM_NAME, ITEM_CONTENT,START_DATE, END_DATE,
						 CURRENT_BIDDER_ID, CURRENT_BIDDER, CURRENT_BID_AMOUNT, CATEGORY_ID, PICTURE_LOCATION)
        VALUES ( 4,
                 '(TEST)Samsung ArtPC PULSE Desktop 1TB SSD 32GB RAM EXTREME PC Computer DP700C6A', 
...
INSERT INTO AUCTION_ITEM (AUCTIONEER_ID, ITEM_NAME, ITEM_CONTENT,START_DATE, END_DATE,
						 CURRENT_BIDDER_ID, CURRENT_BIDDER, CURRENT_BID_AMOUNT, CATEGORY_ID, PICTURE_LOCATION)
        VALUES ( 2,
                 '(TEST)Samsung AMD 2.2GHz 4GB RAM Thin Client TC222W',
...
INSERT INTO AUCTION_ITEM (AUCTIONEER_ID, ITEM_NAME, ITEM_CONTENT,START_DATE, END_DATE,
						 CURRENT_BIDDER_ID, CURRENT_BIDDER, CURRENT_BID_AMOUNT, CATEGORY_ID, PICTURE_LOCATION)
        VALUES ( 2,
                 '(TEST)Dell Optiplex 9010 Business Desktop Computer',
...
INSERT INTO AUCTION_ITEM (AUCTIONEER_ID, ITEM_NAME, ITEM_CONTENT,START_DATE, END_DATE,
						 CURRENT_BIDDER_ID, CURRENT_BIDDER, CURRENT_BID_AMOUNT, CATEGORY_ID, PICTURE_LOCATION)
        VALUES ( 2,
                 '(TEST)Dell OptiPlex Desktop Complete Computer Package',
...
INSERT INTO AUCTION_ITEM (AUCTIONEER_ID, ITEM_NAME, ITEM_CONTENT,START_DATE, END_DATE,
						 CURRENT_BIDDER_ID, CURRENT_BIDDER, CURRENT_BID_AMOUNT, CATEGORY_ID, PICTURE_LOCATION)
        VALUES ( 2,
                 '(TEST)Apple iMac MK482LL/A Retina 5K Display Desktop Computer AppleCare Bundle',
...
INSERT INTO AUCTION_ITEM (AUCTIONEER_ID, ITEM_NAME, ITEM_CONTENT,START_DATE, END_DATE,
						 CURRENT_BIDDER_ID, CURRENT_BIDDER, CURRENT_BID_AMOUNT, CATEGORY_ID, PICTURE_LOCATION)
        VALUES ( 4,
                 '(TEST)CUK ASRock DeskMini 110W Tiny Desktop PC - Intel Core i7-7700, 16GB RAM, 512GB NVMe SSD',
...
INSERT INTO AUCTION_ITEM (AUCTIONEER_ID, ITEM_NAME, ITEM_CONTENT,START_DATE, END_DATE,
						 CURRENT_BIDDER_ID, CURRENT_BIDDER, CURRENT_BID_AMOUNT, CATEGORY_ID, PICTURE_LOCATION)
        VALUES ( 2,
                 '(TEST)Apple MacBook MMGL2LL/A 12-Inch Laptop with Retina Display Rose Gold, 256 GB',
...
INSERT INTO AUCTION_ITEM (AUCTIONEER_ID, ITEM_NAME, ITEM_CONTENT,START_DATE, END_DATE,
						 CURRENT_BIDDER_ID, CURRENT_BIDDER, CURRENT_BID_AMOUNT, CATEGORY_ID, PICTURE_LOCATION)
        VALUES ( 2,
                 '(TEST)2017 NEW HP Envy 17.3 IPS Full HD High Performance Premium Laptop',
...
INSERT INTO AUCTION_ITEM (AUCTIONEER_ID, ITEM_NAME, ITEM_CONTENT,START_DATE, END_DATE,
						 CURRENT_BIDDER_ID, CURRENT_BIDDER, CURRENT_BID_AMOUNT, CATEGORY_ID, PICTURE_LOCATION)
        VALUES ( 2,
                 '(TEST)2016 Acer Aspire 15.6-inch, Intel Celeron Dual-Core Processor up to 2.48GHz, 4GB Memory',
