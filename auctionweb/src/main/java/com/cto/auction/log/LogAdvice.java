...
public class LogAdvice {
 ...
 // .. : 하위의 모든 디렉토리를 의미
 // *(..) : * - 하위의 모든 메서드, (..) - 모든 매개변수
 @Around("execution(* com.cto.auction.controller..*Controller.*(..))"
         + " or execution(* com.cto.auction.service..*Service.*(..))"
         + " or execution(* com.cto.auction.repository..*DAO.*(..))")
